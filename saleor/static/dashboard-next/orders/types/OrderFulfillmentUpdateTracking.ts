...
export interface OrderFulfillmentUpdateTracking_orderFulfillmentUpdateTracking_order_fulfillments_lines_edges_node {
  ...
  id: string;
  quantity: number;
  orderLine: OrderFulfillmentUpdateTracking_orderFulfillmentUpdateTracking_order_fulfillments_lines_edges_node_orderLine;
}
...
export interface OrderFulfillmentUpdateTracking_orderFulfillmentUpdateTracking {
  ...
  errors: (OrderFulfillmentUpdateTracking_orderFulfillmentUpdateTracking_errors | null)[] | null;
